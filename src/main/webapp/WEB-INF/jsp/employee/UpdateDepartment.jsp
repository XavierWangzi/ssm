		...
		<form action="update.do" method="post">
			<input type="hidden" name="id" value="${Department.did}" />
 			<table width="60%" border="0" cellpadding="8" cellspacing="0"
 				...
 				<tr>
 					<td>部门名称:</td>
 					<td><input type="text" name="d_name" value="${Department.dName}" /></td>
 				</tr>
 				<tr>
 					<td>部门描述:</td>
 					<td><input type="text" name="d_descript" value="${Department.dDescritpt}" /></td>
 				</tr>
 				<tr>
 					<td>部门备注:</td>
 					<td><input type="text" name="d_remark"  value="${Department.dRemark}"/></td>
 				</tr>
 				<tr>
