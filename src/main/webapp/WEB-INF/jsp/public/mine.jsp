...
<!-- 					<li><a href="">中文</a></li> -->
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">个人信息<button href="<%=basePath %>empinfo/editMyInfo.do" class="btn btn-right"><span class="glyphicon glyphicon-pencil" aria-hidden="true">修改</span>修改个人信息</button></h1>
				<table class="table table-striped table-hover">
					...
					<tr>
						<td>用户权限</td>
						<td>${empinfopermissions}</td>
					</tr>
					<tr>
						<td>所属部门</td>
						<td>${loginemp.dName}</td>
					</tr>
					<tr>
						<td>入职时间</td>
